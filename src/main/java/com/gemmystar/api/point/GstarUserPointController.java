...
public class GstarUserPointController {
	...
	@ResponseBody
	public SimpleJsonResponse list(SimpleJsonResponse jsonRes, @PageableDefault Pageable pageable, @RequestParam(name = "pcStatusCd", required = false) String pcStatusCd){
