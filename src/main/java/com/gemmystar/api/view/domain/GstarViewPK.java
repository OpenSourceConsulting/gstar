 ...
 * ---------------	----------------	------------
 * BongJin Kwon		2016. 8. 4.		First Draft.
 */
 ...
 * @version 1.0
 */
public class GstarViewPK implements Serializable {
	
	private static final long serialVersionUID = 1565834266661259915L;
	...
	public GstarViewPK(Long gstarUserId, Long gstarContentsId) {
		super();
